...
if ($_POST['tipo'] == 'Embalagens'){
  $produto = $produtosRepositorio->listarAdesivosPorId($_POST['id']);
}else{
  $produto = $produtosRepositorio->listarEmbalagesPorId($_POST['id']);
}
      ...
      <form method="POST" action="../controladora/processar-editar-produto.php" id="editarForm" enctype="multipart/form-data">
        ...
        <div class="container-radio">
          <div>
            ...
            <input type="radio" id="Embalagens" name="tipo" value="Embalagens" <?php if ($produto->getTipo() == "Embalagens") { ?>checked><?php } else { ?> > <?php } ?>
          </div>
          <div>
            <label for="Adesivos">Adesivos</label>
            <input type="radio" id="Adesivos" name="tipo" value="Adesivos" <?php if ($produto->getTipo() == "Adesivos") { ?>checked><?php } else { ?> > <?php } ?>
          </div>
        </div>
